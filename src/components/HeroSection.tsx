...
>
  <div className="relative">
    ...
    <div
      className="absolute -top-10 left-10 px-5 py-4 rounded-2xl bg-cream border border-border animate-float"
    ...
    <div
      className="absolute -top-12 right-2 px-5 py-4 rounded-2xl bg-mint-light border border-border animate-float"
    ...
    <div
      className="absolute top-1/2 -right-14 -translate-y-1/2 px-5 py-4 rounded-2xl bg-coral-light border border-border animate-float"
    ...
    <div
      className="absolute -bottom-4 right-16 px-5 py-4 rounded-2xl bg-peach-light border border-border animate-float"
    ...
    <div
      className="absolute -bottom-8 left-12 px-5 py-4 rounded-2xl bg-lavender-light border border-border animate-float"
